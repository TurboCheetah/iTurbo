...
class addList extends Event {
  async run (ctx, player, res) {
    ...
    const embed = new MessageEmbed()
      ...
      .setThumbnail(res.tracks ? `https://img.youtube.com/vi/${res.tracks[0].identifier}/maxresdefault.jpg` : `https://img.youtube.com/vi/${res.playlist.songs[0].identifier}/maxresdefault.jpg`)
