...
exports.levelUpMessages = [
  ...
  "B-You're at level **{{level}}**, now go be free! D-dummy...",
...
exports.pingMessages = [
  ...
  "B-My ping is **{{ms}}ms**! Are you happy now?"
];
...
exports.notNSFWChannel = [
  "What do you think you're doing? That command can only be used in NSFW channels.",
