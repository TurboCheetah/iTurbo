...
class Command {
  constructor(client, file, options) {
    ...
    this.description = this.client.utils.isFunction(options.description) ? options.description(this.client.translations.get('en-US')) : options.description || 'No Description Provided.'
    this.extendedHelp = this.client.utils.isFunction(options.extendedHelp) ? options.extendedHelp(this.client.translations.get('en-US')) : options.extendedHelp || 'No extended help provided.'
    ...
    this.usage = this.client.utils.isFunction(options.usage) ? options.usage(this.client.translations.get('en-US')) : options.usage || this.name
  ...
  async verifyUser(ctx, user, defaultToAuthor = false) {
    ...
    if (!match) throw "That's not a user mention or an ID. What were you trying to do?"
