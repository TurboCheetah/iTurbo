...
class MiyakoClient extends Client {
  constructor (dev) {
    ...
    this.distube = new DisTube(this, { searchSongs: true, emitNewSongOnly: true, highWaterMark: 1 << 25, customFilters: { purebass: 'bass=g=20,dynaudnorm=f=200,asubboost,apulsator=hz=0.08' } }) // Distube instance for playing music
    this.version = '1.0.3'
