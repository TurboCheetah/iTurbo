...
class DM extends Command {
  ...
  async run(ctx, [user, ...message]) {
    ...
    try {
      await user.send(`${message.join(' ')}\n\n**The message above was sent by the bot owner. You may join our support server at https://discord.gg/011UYuval0uSxjmuQ for replying and further discussions.**`)
